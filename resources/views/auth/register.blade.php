...
<body>
    <div class="content-principal">
        <div class="imagen-side">
            <img src="{{ asset('images/backgrounds/imagen_entorno.jpg') }}" alt="Logo Secretaría de Salud"
                class="logo-side">
        ...
        <div class="register-panel">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="name" type="text" name="name" placeholder="Ingrese su nombre completo"
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" placeholder="usuario@ejemplo.com"
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="document_type" name="document_type" required>
                            ...
                            <option value="CC" {{ old('document_type') == 'CC' ? 'selected' : '' }}>Cédula de ciudadanía
                            </option>
                            <option value="TI" {{ old('document_type') == 'TI' ? 'selected' : '' }}>Tarjeta de identidad
                            </option>
                            <option value="CE" {{ old('document_type') == 'CE' ? 'selected' : '' }}>Cédula de extranjería
                            </option>
