...
<div class="container py-4 bienvenida-bg" style="background-image: url('{{ asset('images/imagen_entorno.jpg') }}'); background-size: cover; background-position: center; border-radius: 8px; padding: 30px;">
    ...
    <div class="mb-5" style="text-align:center;">
        <video id="gestionVideo" width="100%" controls style="max-width:800px; border-radius:8px; box-shadow:0 2px 8px rgba(0,0,0,0.2);">
            <source src="{{ asset('videos/Mas_bienestar_ruralidad.mp4') }}" type="video/mp4">
    ...
    <div id="geniallyContainer" class="container-wrapper-genially" style="position: relative; min-height: 400px; max-width: 100%; margin: 0 auto;">
        ...
        <div id="6893e9fda1dcf302e7411d14" class="genially-embed" style="margin: 0 auto; position: relative; height: auto; width: 100%;"></div>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let video = document.getElementById('gestionVideo');
