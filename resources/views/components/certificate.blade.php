...
<body>
    <div class="certificate-container">
        ...
        <div class="header">
            <div class="logo-left">
                <div class="logo-circle">
                    ...
                    <div
                        style="width:100%;height:100%;background:#fff;display:flex;align-items:center;justify-content:center;color:#0079A7;font-size:10px;">
                        @if (isset($logo_left))
                            <img src="data:image/png;base64,{{ $logo_left }}" alt="Logo norte" width="120"
        ...
        <div class="certificate-content">
            ...
            <p class="certificate-text">La Secretaría Distrital de Salud de Bogotá y Subred Integrada De Servicios De
                Salud {{ Auth::user()->subred }} E.S.E.</p>
            ...
            <p class="certificate-text">Por haber completado satisfactoriamente los módulos de la herramienta virtual
                para el fortalecimiento de competencias de los Equipos</p>
            <h3 class="module-name">MÁS Bienestar en tu Hogar</h3>
            <p class="certificate-text">en reconocimiento</p>
